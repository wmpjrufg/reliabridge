...
* *Tabuleiro:* Seção Retangular com $b_w = 12.0$ cm e $h = 35.0$ cm.
...
| *Momento Permanente* | $M_{gk}$ | 7.17 | kN.m |
| *Momento Variável* | $M_{qk}$ | 75.75 | kN.m |
| *Momento de Cálculo* | *$M_{sd}$* | *123.31* | *kN.m* (Majorado) |
...
* *Tensão Atuante ($\sigma_{x,d}$):* 13.78 MPa
...
* *Cortante de Cálculo ($V_{sd}$):* 102.44 kN
* *Tensão Atuante ($\tau_{sd}$):* 0.86 MPa
...
| :--- | :---: | :---: | :---: |
| *Flecha Instantânea ($Q$)* | 0.33 cm | - | - |
| *Flecha Fluência* | 0.20 cm | - | $\phi = 0.6$ |
| *Flecha Variável (Lim.)* | *1.11 cm* | *- cm* | *OK* |
...
* *Tensão Atuante ($\sigma_{x,d}$):* 5.83 MPa
* *Resistência ($f_{md}$):* 17.14 MPa
