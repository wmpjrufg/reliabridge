...
Uso:
    .venv\\Scripts\\python.exe rodar_lote_robustez_materia.py
    .venv\\Scripts\\python.exe rodar_lote_robustez_materia.py --apenas rho000   # só um nível
    .venv\\Scripts\\python.exe rodar_lote_robustez_materia.py --retomar         # continua de onde parou
...
if __name__ == "__main__":
    raise SystemExit(
        main(
            planilha_padrao="robustez_casos_materia.xlsx",
