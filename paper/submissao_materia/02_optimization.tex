...
Em paralelo, \textcite{SimoesNegrao1994} formularam um problema multiobjetivo com metas de redução de custo e de tensões em pontes metálicas estaiadas, adotando como variáveis as dimensões das seções e as posições de ancoragem dos estais no tabuleiro e nas torres.
...
Mais recentemente, \textcite{deMoraes2025} combinaram modelagem tridimensional, algoritmo genético, análise por elementos finitos e busca local pelo método Simplex no projeto de pontes com vigas de concreto protendido.
