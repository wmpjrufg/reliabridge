...
\begin{figure}[!ht]
    ...
    \begin{subfigure}{0.8\textwidth}
        \centering
        \includegraphics[width=\textwidth]{figuras/inicio.png}
    ...
    \begin{subfigure}{0.8\textwidth}
        \centering
        \includegraphics[width=\textwidth]{figuras/predimencionamento.png}
        \caption{Módulo de dimensionamento por otimização.}
        \label{fig:interface_dim}
    \end{subfigure}
    \caption{Interface da plataforma computacional.}
    \label{fig:interface}
\end{figure}
...
\begin{figure}[!ht]
    \centering
    \includegraphics[width=0.6\textwidth]{figuras/convergencia_hv.png}
...
\begin{figure}[!ht]
    ...
    \begin{subfigure}{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{figuras/abaco_volume_vs_vao.png}
    ...
    \begin{subfigure}{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{figuras/abaco_volume_por_m2.png}
    ...
    \begin{subfigure}{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{figuras/abaco_diametro_vs_vao.png}
