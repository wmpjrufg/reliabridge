...
A plataforma aplica ainda um fator de atenuação sobre o excedente do coeficiente de impacto em relação à unidade, de modo que apenas 75\% desse excedente amplifique de fato os esforços variáveis, conforme a Equação~\eqref{eq:civaux}. O fator resultante, $aux_{ci}$, multiplica diretamente $M_{qk}$ e $Q_{qk}$, tanto da longarina quanto do tabuleiro.
