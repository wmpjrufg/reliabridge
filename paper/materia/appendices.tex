...
Já na combinação rara, exigida em paralelo, verifica-se a flecha instantânea total das ações permanente e variável, sem fluência: $\delta_{\mathrm{inst}} = \delta_{gk} + \delta_{qk} = 0{,}202 + 1{,}543 = 1{,}745$~mm contra $\delta_{lim,inst} = L/500 = 10{,}000$~mm, utilização de $17{,}4\%$ ($g_{3b} = -0{,}8255$), que é a mais severa das duas e portanto governa: $g_3 = \max(g_{3a}, g_{3b}) = -0{,}8255$. Os índices de utilização e as restrições são calculados antes do arredondamento das flechas apresentadas.
...
$g_3$: flecha da longarina & $-0{,}8255$ & $-0{,}8255$ & $< 0{,}001\%$ \\
