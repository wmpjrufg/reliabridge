...
$E_{c0,med}$ \> Módulo de elasticidade médio na compressão paralela às fibras, por classe (MPa)\\
$E_{c0,m}^{\mathrm{exp}}$ \> Módulo de elasticidade médio experimental na compressão paralela às fibras, por espécie (MPa)\\
$E_{c0,m}^{\mathrm{NBR}}$ \> Módulo de elasticidade médio atribuído à classe pela ABNT NBR 7190-3:2022 (MPa)\\
...
$\varepsilon_E$ \> Erro de rigidez, $100(E_{c0,m,c_s}^{\mathrm{NBR}}/E_{c0,m,s}^{\mathrm{exp}}-1)$ (\%)\\
