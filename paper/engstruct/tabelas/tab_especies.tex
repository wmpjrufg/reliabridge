...
\item Valores característicos obtidos por $f_k = 0{,}70\,f_m$ para compressão e flexão e $f_k = 0{,}54\,f_m$ para cisalhamento, conforme a ABNT NBR 7190-1:2022. \tofill{[Conversão provisória da base atual. Wolenski et al. (2020) já publicam resistências características; reconciliar as fontes antes de recalcular.]}
\item Fonte: \tofill{[Identificar a origem de cada coluna. A população e as propriedades desta tabela não coincidem integralmente com as de]} \textcite{Wolenski2020}.
\end{tablenotes}
\end{threeparttable}
\end{table}
