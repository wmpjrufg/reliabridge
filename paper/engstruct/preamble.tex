% Language setting -- versao de trabalho em portugues. Ver vault/02_paper_engstruct.md:
% a submissao ao Engineering Structures exige retraducao para o ingles.
...
\usepackage{longtable}      % Multipage tables in the appendices
