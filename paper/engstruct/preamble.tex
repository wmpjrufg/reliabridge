% Language setting -- artigo em ingles. Os blocos \tofill e fillblock permanecem
% em portugues por serem instrucoes internas de preenchimento, nao texto final.
...
%\DeclareLanguageMapping{brazil}{brazilian-apa} % nao se aplica ao artigo em ingles
