...
textos = {
            "pt": {
                    ...
                    "fc_k": "Resistência característica à compressão paralela às fibras (kN/m²)",
                    "ft_k": "Resistência característica à tração paralela às fibras (kN/m²)",
                    "e_modflex": "Módulo de elasticidade à flexão (kN/m²)",
            ...
            "en": {
                    ...
                    "fc_k": "Characteristic compressive strength parallel to grain (kN/m²)",
                    "ft_k": "Characteristic tensile strength parallel to grain (kN/m²)",
                    "e_modflex": "Modulus of elasticity in bending (kN/m²)",
                    "botao": "Check beam",
...
fc_k = st.number_input(t["fc_k"], value=20.0)
ft_k = st.number_input(t["ft_k"], value=15.0)
e_modflex = st.number_input(t["e_modflex"], value=12000.0)
